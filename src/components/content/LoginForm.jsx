...
export default function LoginForm() {
  ...
  return (
    <div className="w-full md:w-3/5 min-h-full flex items-center justify-center">
      <form className="md:w-3/5 sm:w-2/3 w-4/5 h-auto p-4" onSubmit={handleSubmit}>
        <h2 className="text-4xl outfit-medium">Welcome!</h2>
        <p className="text-neutral-700 mb-5">Log in to Library Dashboard to continue.</p>
        ...
        <div className="grid gap-y-3">
          ...
          <div className="w-full grid gap-y-1">
            <div className="w-full flex items-center justify-between">
              ...
              <a href="#" className="text-md text-indigo-500 outfit-regular">Forgot password?</a>
            </div>
            <input
              className="border border-[#d7d7d7] outline-2 outline-transparent hover:border-indigo-500 focus:border-transparent focus:outline-indigo-500 transition-all rounded-md text-md px-[10px] py-[6px]"
              type="password"
        ...
        <div className="mt-8 w-full flex items-center justify-start gap-2">
          <button className="w-full px-4 py-2 border border-[#d7d7d7] bg-neutral-800 text-white rounded-md hover:bg-neutral-600 transition-all" type="submit">Log in with Email</button>
        ...
        <div className="w-full py-2">
          <p className="text-center text-md text-neutral-700">Don't have an account? <Link to="/register" className="text-indigo-600">Sign up</Link></p>
        </div>
      </form>
    </div>
  )
