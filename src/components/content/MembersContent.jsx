...
export default function MembersContent() {
  ...
  return (
    <div className="w-full h-full flex flex-col md:gap-0 md:flex-row bg-white overflow-y-auto">
      <div className="w-full md:w-3/4 h-auto md:overflow-y-auto p-4">
        <div className="w-full h-full flex flex-col gap-4">
          <div className="w-full h-auto rounded-xl bg-[#fcfcfc] shadow border border-[#ebebeb] p-4">
            ...
            <div className="w-full flex flex-col sm:flex-wrap items-center gap-4">
              <div className="w-full sm:w-[23.5%] h-full bg-white shadow-sm hover:shadow-lg hover:-translate-y-[2px] border border-[#ebebeb] rounded-lg p-4 transition-all">
          ...
          <div className="pb-4">
            <div className="w-full h-full bg-[#fcfcfc] flex flex-col rounded-xl shadow border border-[#ebebeb]">
              ...
              <div className="w-full flex flex-col overflow-x-auto py-4 divide-neutral-200">
                    ...
                    {users.map((user) => (
                      <tr key={user.id} className="bg-white border-b-1 border-[#ebebeb]">
                        ...
                        <td className="p-3 min-w-[12rem] text-nowrap flex items-center justify-start gap-1">
                          <button onClick={() => handleUpdate(user)} className="px-2 py-1 rounded-md border-1 border-transparent hover:bg-white hover:border-[#ebebeb] bg-yellow-100 text-yellow-400 text-sm transition-all">Update</button>
      ...
      <div className="w-full md:w-1/4 h-auto md:overflow-y-auto py-4 pe-2">
        <div className="w-full h-full">
          <div className="w-full h-full md:bg-[#fcfcfc] md:rounded-xl md:shadow md:border md:border-[#ebebeb] p-4">
            ...
            <br />
            <div className="w-full md:px-[2rem]">
              <form className='w-full rounded-xl border border-[#ebebeb] p-4 md:p-[3rem]'>
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                  <button onClick={() => handleCancel()} type="button" className="text-md/6 font-semibold text-gray-900">
                    Cancel
                  </button>
                  <button
                    type="submit"
