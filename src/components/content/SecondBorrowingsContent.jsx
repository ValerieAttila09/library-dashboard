...
export default function BorrowingsContent() {
  ...
  useEffect(() => {
    ...
    const uniqueBorrowers = new Set(borrowings.map((b) => b.borrower_email))
    setBorrowerCount(uniqueBorrowers.size)
  }, [borrowings])
  ...
  return (
    <div className="relative w-full h-full overflow-y-auto bg-transparent">
      <StatsCards totalLoan={totalLoan} borrowerCount={borrowerCount} />
